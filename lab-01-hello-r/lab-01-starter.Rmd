...
I'm some text, you should replace me with text that tells the reader (Martina and me) what you are doing in the code chunk below.

```{r plot-star}

```

I'm some text, you should replace me with text that tells the reader whether the correlation coefficients are the same for star and dino.
