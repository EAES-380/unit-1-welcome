...
**The starter file is where you will make all your changes. You will not need to make any edits to the instructions files throughout the course (`lab-01-hello-r.Rmd`).** (Unless you are fixing one of my typos ;) )
