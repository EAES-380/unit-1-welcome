...
- Interpret graphical patterns using complete scientific sentences.
- Practice a reproducible R Markdown workflow.

# Deliverables

Submit your completed knitted HTML file and the corresponding `.Rmd` file to GitHub Classroom.

## Before You Begin

- Pull the latest version of your repository.
- Open the starter `.Rmd` file.
- Knit frequently as you work.
- Run your code from top to bottom rather than individual lines.

## Before asking for help

Check the following:

- Does your document Knit?
- Did you Run All?
- Did you spell every variable name correctly?
- Did you forget a quotation mark, comma, or parenthesis?
...
-   Skip down to **Owner** and choose `EAES-380`. **Do NOT choose your own account!**
...
- [ ] My document knits without errors.
- [ ] I removed all instructional placeholder text.
- [ ] All code is included in the R Markdown document.
- [ ] I answered every question in complete sentences.
